...
def main():
    ...
    # load FAISS index (with the same Sentence-Transformer embeddings wrapper)
    ...
    # load a local seq2seq LLM (flan-t5-small) for generation
    ...
    while True:
        ...
        # build a single prompt combining retrieved chunks + user query
